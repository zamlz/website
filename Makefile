...
# .wiki.md files are not checked in to git and are autogenerated, but their
# respective html files should not have .wiki in their name
...
WIKI_MD_CONVERTOR = ./scripts/wiki2md.sh
...
${WIKI_MD}: ${WIKI_DIR}/%.wiki.md: ${VIMWIKI_DIR}/%.md ${WIKI_HEADER}
